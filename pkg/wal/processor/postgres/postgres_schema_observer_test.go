...
func TestPGSchemaObserver_updateGeneratedColumnNames(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "plain columns",
			cols: []wal.DDLColumn{
				{Attnum: 1, Name: "id", Type: "integer"},
				{Attnum: 2, Name: "name", Type: "text"},
			},
		...
		},
		{
			...
			cols: []wal.DDLColumn{
				{Attnum: 1, Name: "id", Type: "integer"},
				{Attnum: 2, Name: "full_name", Type: "text", Generated: true},
			},
		...
		},
		{
			...
			cols: []wal.DDLColumn{
				{Attnum: 1, Name: "id", Type: "bigint", Identity: &always},
				{Attnum: 2, Name: "name", Type: "text"},
			},
		...
		},
		{
			...
			// via IsGenerated() (Identity != nil). It is NOT in the
			// alwaysIdentity map since PG accepts explicit values for it in
			// UPDATE SET.
			name: "by-default identity column",
			cols: []wal.DDLColumn{
				{Attnum: 1, Name: "id", Type: "bigint", Identity: &byDefault},
				{Attnum: 2, Name: "name", Type: "text"},
			},
		...
		},
		{
			...
			cols: []wal.DDLColumn{
				{Attnum: 1, Name: "id", Type: "bigint", Identity: &always},
				{Attnum: 2, Name: "request_id", Type: "bigint", Identity: &always},
				{Attnum: 3, Name: "full_name", Type: "text", Generated: true},
				{Attnum: 4, Name: "name", Type: "text"},
			},
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			obs.updateGeneratedColumnNames([]wal.DDLObject{
				{
					Type:     "table",
					Identity: quotedTable,
					Schema:   testSchema,
					Columns:  tc.cols,
				},
			})
